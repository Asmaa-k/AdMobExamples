...
class InterstitialAdActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        MobileAds.setRequestConfiguration(RequestConfiguration.Builder().setTestDeviceIds(listOf("ABCDEF012345")).build())
            ...
            adListener = (
                    object : AdListener() {
                        override fun onAdLoaded() {
                            Toast.makeText(this@InterstitialAdActivity, "onAdLoaded()", Toast.LENGTH_SHORT).show()
                        }
