package com.example.adsexamples.nativeAdapter
...
import com.example.adsexamples.R
import com.example.adsexamples.nativeAdapter.RecyclerViewAdapter.MenuItemViewHolder
 ...
 */(
    ...
    private val mRecyclerViewItems: List<Any>
) :
    ...
    inner class MenuItemViewHolder internal constructor(view: View) :
        ...
        init {
            menuItemImage =
                view.findViewById<View>(R.id.menu_item_image) as ImageView
            menuItemName = view.findViewById<View>(R.id.menu_item_name) as TextView
            menuItemPrice = view.findViewById<View>(R.id.menu_item_price) as TextView
            menuItemCategory =
                view.findViewById<View>(R.id.menu_item_category) as TextView
            menuItemDescription =
                view.findViewById<View>(R.id.menu_item_description) as TextView
        }
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        when (viewType) {
            ...
            MENU_ITEM_VIEW_TYPE -> {
                ...
                val menuItem =
                    mRecyclerViewItems[position] as MenuItem
